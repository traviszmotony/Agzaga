...
module Spree
  module Admin
    class StoreCreditsController < ResourceController
      ...
      def parent
        @parent = Spree::User.with_discarded.find(params[:user_id])
        @user = @parent
      end
...
# touched on 2025-05-22T19:13:58.235184Z
# touched on 2025-05-22T19:23:41.752163Z
# touched on 2025-05-22T23:07:43.222149Z