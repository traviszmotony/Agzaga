...
module Spree
  class OrderContents
    ...
    def add(variant, quantity = 1, options = {})
      ...
      after_add_or_remove(line_item, options) unless ['custom_hose', 'hose_fitting'].include?(variant.product.product_type)
    end
    ...
    def update_cart(params)
      if order.update(params)
        unless order.completed?
          removing_product = order.line_items.find_by(quantity: 0)&.product
          if removing_product&.for_custom_hose?
...
# touched on 2025-05-22T20:39:06.155103Z
# touched on 2025-05-22T22:45:03.954508Z
# touched on 2025-05-22T23:37:07.701241Z