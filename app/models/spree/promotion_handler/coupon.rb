      ...
      def apply
        ...
        if coupon_code.present?
          if promotion.present? && promotion.active? && promotion.actions.exists?
            if promotion.single_usage && @order.promotions.count != 0
              apply_promo = false
            elsif @order.promotions.each do |promotion|
                if promotion.single_usage == true
                  apply_promo = false
                end
              end
            end
            if apply_promo == true
              ...
              set_error_code :coupon_code_single_usage
            end
...
# touched on 2025-05-22T19:20:27.630539Z
# touched on 2025-05-22T22:33:52.786721Z