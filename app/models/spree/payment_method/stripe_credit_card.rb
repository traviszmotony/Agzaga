...
module Spree
  class PaymentMethod
    class StripeCreditCard < Spree::PaymentMethod::CreditCard
      ...
      def gateway_class
        card_token = payments.last.source.gateway_payment_profile_id.split('_').first.include?('tok')

        if v3_intents? && !card_token
      ...
      def create_profile(payment)
        ...
        card_token = source.gateway_payment_profile_id.split('_').first.include?('tok')
...
# touched on 2025-05-22T23:27:49.288012Z