  ...
  module Stock
    class Estimator
      ...
      def shipping_methods(package)
        shipping_package = package.shipping_methods
                          .available_to_store(package.shipment.order.store)

        shipping_package = shipping_package.available_for_address(package.shipment.order.ship_address) if package.order.ship_address.present?

        shipping_package.includes(:calculator)
          .to_a
...
# touched on 2025-05-22T21:58:00.788439Z
# touched on 2025-05-22T23:26:38.897538Z
# touched on 2025-05-22T23:44:29.948444Z