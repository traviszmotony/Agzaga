          ...
          def define_state_machine!
            ...
            state_machine :state, initial: :cart, use_transactions: false do
              ...
              if states[:payment]
                ...
                before_transition to: :complete, do: :add_store_credit_payments
              ...
              if states[:payment]
                before_transition to: :payment, do: :ensure_shipping_address
                before_transition to: :payment, do: :create_proposed_shipments
                before_transition to: :payment, do: :ensure_available_shipping_rates
                before_transition from: :payment, do: :apply_shipping_promotions
              end
...
# touched on 2025-05-22T23:39:06.877499Z